    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="flex justify-end mb-8">
                <a href="{{route('admin.categories.create')}}" class="px-6 py-2 font-bold text-white bg-green-600 rounded shadow">Criar Categoria</a>
            </div>
                                ...
                                @forelse($categories as $product)
                                    <tr>
                                        ...
                                        <td class="flex justify-between w-48 px-6 py-4 text-sm text-center text-gray-500 whitespace-nowrap">
                                            <a href="{{route('admin.categories.edit', $product)}}" class="font-bold text-blue-500 transition-all duration-200 ease-in-out hover:text-blue-200 hover:underline">EDITAR</a>
